...
- [React Hooks Docs](https://react.dev/reference/react-dom/hooks)
...
- [Sanely Testing React Hooks](https://dev.to/grug/sanely-testing-react-hooks-2l1j)
- [React by Example: Hooks](https://reactbyexample.github.io/hooks)

## Videos

- [🎬 ReactConf 2018: React Today and Tomorrow](https://youtu.be/V-QO-KO90iQ) Official announcement and first demo.
- [🎬 ReactConf 2018: 90% Cleaner React](https://youtu.be/wXLf18DsV-I)
- [🎬 React Hooks: A Complete Introduction](https://youtu.be/jd8R0a2Ur8Q)
- [🎬 React Hooks playlist](https://www.youtube.com/playlist?list=PLN3n1USn4xllL1OrVr-A4oq7SG-cS9MOQ)
- [🎬 React Hooks playlist](https://www.youtube.com/playlist?list=PLj2oFNVaxfJ-AcPo191jz09g-v9CLRfCg)
- [🎬 React Hooks playlist](https://www.youtube.com/playlist?list=PLnc_NxpmOxaNf_mTUx1BgoP5POXwSAu-g)
- [🎬 Custom Hooks in React](https://www.youtube.com/watch?v=J-g9ZJha8FE)
...
- [`style-hook`](https://github.com/style-hook/style-hook) 🎨 Write css in js with react hooks.
