...
/*
useArray is a custom React hook that allows a component to manage an array state. It uses the built-in useState hook
from the React library. The hook takes in an argument, defaultValue, which is used to initialize the array state. The
hook returns an object with several properties:
...
All the functions that change the array state use the setArray function. Still, they do it in a way that preserves the
immutability of the state by creating a new array, adding or removing the elements, and then passing it to the setArray
function.
*/
...
perform everyday array operations such as adding, removing, updating, and filtering elements.
*/
